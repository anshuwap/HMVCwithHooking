...
hooks()->add_filter('staff_permissions', 'recruitment_permissions');
/**
 ...
 * @return
 */
function recruitment_permissions($permissions) {
	$capabilities = [];
	...
	return register_staff_capabilities('recruitment', $capabilities, _l('recruitment'), $permissions);
}
