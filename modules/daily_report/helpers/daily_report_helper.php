...
function app_admin_setup_menu_custom_options1($items)
{
    return _apply_menu_items_options1($items, json_decode(get_option('setup_menu_active')));
}

function app_admin_setup_menu_custom_positions1($items)
{
    return _apply_menu_items_position1($items, json_decode(get_option('setup_menu_active')));
}

function _apply_menu_items_options1($items, $options)
{
...
function _apply_menu_items_position1($items, $options)
{
    if (!is_array($options)) {
        $CI = &get_instance();
        // Has applied options
...
function _menu_options_filter_child1($menu_options, $slug)
{
...
function app_get_menu_setup_icon1($menu_options, $slug, $group)
{
