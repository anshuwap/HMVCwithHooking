...
<legend style="text-align: left;margin-top:-15px;font-size:14px">Projects</legend>
  <?php
                     $selected = (isset($expense) ? $expense->Project  : '');
                     ...
                     ?>
                      <div class="row">
                          ...
                          <div class="col-md-4"><br>
                              <button type="button" class="btn btn-primary" id="add_task" style="margin-top:8px"><a href="#"  style="color:white"><i class="fa fa-plus" style="color:white"></i>Add new</a></button>
                          </div>
                          <div id="extratask">
...
$(document).ready(function(){
  $("#add_task").click(function(){
    $("#extratask").append('<div class="row"><div class="col-md-8"><?php echo render_input("expense_name","expense_name",$value); ?></div><div class="col-md-4"><br><button id="remove" class="remove-btn" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i>X</button></div><div id="extratask"></div></div>');
  });
   $('#remove').click(function (){
        $(this).parents('#add_task').remove();
   })
});
</script>     
