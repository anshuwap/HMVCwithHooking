...
hooks()->add_filter('staff_permissions', 'account_planning_permissions');
...
function account_planning_permissions($permissions)
{
    $capabilities = [];
    ...
    register_staff_capabilities('account_planning', $capabilities, _l('account_planning'), $permissions);
}