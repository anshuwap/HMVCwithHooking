...
Description: Human Resource Management module for Binplus CRM
Version: 2.3.0
...
hooks()->add_filter('staff_permissions', 'hrm_permissions');
/**
...
function hrm_permissions($permissions)
{
    $capabilities = [];
    ...
    return register_staff_capabilities('hrm', $capabilities, _l('hrm'), $permissions);
}
