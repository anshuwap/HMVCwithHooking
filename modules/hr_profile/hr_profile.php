...
hooks()->add_filter('staff_permissions', 'hr_profile_permissions');
...
function hr_profile_load_js(){    
	 ...
	 */
	function hr_profile_permissions($permissions)
	{
		...
		//Dashboard
		register_staff_capabilities('hrm_dashboard', $dashboard, _l('HR_dashboard'), $permissions);
		//Orgranization
		register_staff_capabilities('staffmanage_orgchart', $capabilities_2, _l('HR_organizational_chart'), $permissions);
		//Onboarding Process
		register_staff_capabilities('hrm_reception_staff', $capabilities, _l('HR_reception_staff'), $permissions);
		//Hr Profile
		register_staff_capabilities('hrm_hr_records', $capabilities, _l('hr_hr_records'), $permissions);
		//Job Description
		register_staff_capabilities('staffmanage_job_position', $capabilities_2, _l('HR_job_escription'), $permissions);
		//Training
		register_staff_capabilities('staffmanage_training', $capabilities, _l('HR_training'), $permissions);
		//Q&A
		register_staff_capabilities('hr_manage_q_a', $capabilities, _l('HR_q&a'), $permissions);
		//Contracts
		register_staff_capabilities('hrm_contract', $capabilities, _l('HR_contract'), $permissions);
		//Dependent Persons
		register_staff_capabilities('hrm_dependent_person', $capabilities, _l('HR_dependent_persons'), $permissions);
		//Resignation procedures
		register_staff_capabilities('hrm_procedures_for_quitting_work', $capabilities, _l('HR_resignation_procedures'), $permissions);
		//Reports
		register_staff_capabilities('hrm_report', $dashboard, _l('HR_report'), $permissions);
		//Settings
		register_staff_capabilities('hrm_setting', $capabilities, _l('HR_setting'), $permissions);
