    ...
    <div class="row">
      <div class="col-md-12">
            <div class="panel_s">
             ...
             <?php $this->load->view('admin/projects/table_html_oneview'); ?>
          </div>
        </div>
      </div>
    </div>
...
$(function(){
     ...
     initDataTable('.table-projects', admin_url+'projects/table_oneview', undefined, undefined, ProjectsServerParams, <?php echo hooks()->apply_filters('projects_table_default_order', json_encode(array(5,'asc'))); ?>);
