...
<div class="tab-content">
 ...
 <div role="tabpanel" class="tab-pane" id="leads">
  <i class="fa fa-question-circle pull-left" data-toggle="tooltip" data-title="<?php echo '0 for default time, -1 for disable and 15 minute minimum time required.'; ?>"></i>
  <?php echo render_input('settings[auto_retrieve_leads_after]','Indiamart Leads Cron (Minutes)',get_option('auto_retrieve_leads_after'),'number');
    $auto_retrieve_leads_last_cron = get_option('auto_retrieve_leads_last_cron');
  ?>
  <hr />
  <div class="alert alert-warning">
    Last Cron run with IndiaMart Leads API on: <h3><?= date('d M, Y h:i:s A', $auto_retrieve_leads_last_cron) ?></h3>
  </div>
