...
<div class="panel_s<?php if(!isset($invoice) || (isset($invoice) && count($invoices_to_merge) == 0 && (isset($invoice) && !isset($invoice_from_project) && count($expenses_to_bill) == 0 || $invoice->status == Gstinvoices_model::STATUS_CANCELLED))){echo ' hide';} ?>" id="invoice_top_info">
   <div class="panel-body">
      <div class="row">
         <div id="merge" class="col-md-6">
            <?php
              if(isset($invoice)){
                 $this->load->view('admin/gstinvoices/merge_invoice', array('invoices_to_merge'=>$invoices_to_merge));
              }
            ?>
         </div>
         ...
         <?php if(!isset($invoice_from_project)){ ?>
           <div id="expenses_to_bill" class="col-md-6">
              <?php if(isset($invoice) && $invoice->status != Gstinvoices_model::STATUS_CANCELLED){
                 $this->load->view('admin/gstinvoices/bill_expenses',array('expenses_to_bill'=>$expenses_to_bill));
              } ?>
           </div>
         <?php } ?>
      </div>
         ...
         <div class="col-md-6">
            ...
            <div class="row">
               ...
               <hr class="hr-10" />
                  ...
                  <?php include_once(APPPATH .'views/admin/gstinvoices/billing_and_shipping_template.php'); ?>
               </div>
               <div class="col-md-6">
