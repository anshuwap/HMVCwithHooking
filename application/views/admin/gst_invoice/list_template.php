...
<div class="col-md-12">
   <div class="panel_s mbot10">
      <div class="panel-body _buttons">
         <?php $this->load->view('admin/gst_invoice/invoices_top_stats'); ?>
         <?php if(has_permission('invoices','','create')){ ?>
            <a href="<?php echo admin_url('gstinvoices/invoice'); ?>" class="btn btn-info pull-left new new-invoice-list mright5"><?php echo _l('create_new_invoice'); ?></a>
         <?php } ?>
         <?php if(!isset($project)){ ?>
               <a href="<?php echo admin_url('gstinvoices/recurring'); ?>" class="btn btn-info pull-left">
      ...
      <div class="col-md-12" id="small-table">
         <div class="panel_s">
            <div class="panel-body">
               ...
               <?php $this->load->view('admin/gst_invoice/table_html'); ?>
            </div>
         </div>
      </div>
