...
<div class="row">
   ...
   <div class="col-lg-4 col-xs-12 col-md-12 total-column">
      <div class="panel_s">
         <div class="panel-body">
            <h3 class="text-muted _total">
               <?php echo app_format_money($total_pay_result['due'], $total_pay_result['currency']); ?>
            </h3>
            <span class="text-warning"><?php echo _l('Current Outstanding'); ?></span>
         </div>
      </div>
   </div>
   <div class="col-lg-4 col-xs-12 col-md-12 total-column">
      <div class="panel_s">
         <div class="panel-body">
            <h3 class="text-muted _total">
               <?php echo app_format_money($total_pay_result['overdue'], $total_pay_result['currency']); ?>
            </h3>
            <span class="text-danger"><?php echo _l('Total Past Due'); ?></span>
         </div>
      </div>
   </div>
   <div class="col-lg-4 col-xs-12 col-md-12 total-column">
      <div class="panel_s">
         <div class="panel-body">
            <h3 class="text-muted _total">
               <?php echo app_format_money($total_pay_result['paid'], $total_pay_result['currency']); ?>
            </h3>
            <span class="text-success"><?php echo $total_pay_result['pay_session']; ?></span>
         </div>
      </div>
   </div>
