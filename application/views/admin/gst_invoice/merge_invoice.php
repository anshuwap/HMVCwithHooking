...
if(count($invoices_to_merge) > 0){ ?>
    ...
    <?php foreach($invoices_to_merge as $_inv){ ?>
        <div class="checkbox">
            ...
            <label for="">
                <a href="<?php echo admin_url('gstinvoices/list_invoices/'.$_inv->id); ?>" data-toggle="tooltip" data-title="<?php echo format_invoice_status($_inv->status,'',false); ?>" target="_blank">
