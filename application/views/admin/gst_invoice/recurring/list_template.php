...
<div class="col-md-12">
   <div class="panel_s mbot10">
      <div class="panel-body _buttons">
         ...
         <a href="<?php echo admin_url('gstinvoices/invoice'); ?>" class="btn btn-info pull-left new new-invoice-list">
         <?php echo _l('create_new_invoice'); ?>
         </a>
         <?php } ?>
         <a href="<?php echo admin_url('gstinvoices'); ?>" class="btn btn-default pull-left mleft5">
            <?php echo _l('go_back'); ?>
         </a>
      ...
      <div class="col-md-12" id="small-table">
         <div class="panel_s">
            <div class="panel-body">
               ...
               <?php $this->load->view('admin/gstinvoices/recurring/table_html'); ?>
            </div>
         </div>
      </div>
