...
<div id="stats-top" class="hide">
  ...
  <div class="panel_s mtop20">
    <div class="panel-body">
      ...
      $total_invoices = total_rows(db_prefix().'gstinvoices',$where_all);
      ?>
      <div class="row text-left quick-top-stats">
        <?php foreach($invoices_statuses as $status){
          if($status == Gstinvoices_model::STATUS_CANCELLED){
            continue;
          }
        ...
        $total_by_status = total_rows(db_prefix().'gstinvoices',$where);
