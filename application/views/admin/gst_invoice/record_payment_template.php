...
<div class="col-md-12 no-padding animated fadeIn">
    <div class="panel_s">
        <?php echo form_open(admin_url('gstinvoices/record_payment'),array('id'=>'record_payment_form')); ?>
        ...
        <div class="panel-body">
           ...
           <hr class="hr-panel-heading" />
                ...
                <div class="col-md-6">
                    ...
                    if($totalAllowed === 0) {
                        ...
                        <div class="alert alert-info">
                            ...
                            Click <a href="<?php echo admin_url('gstinvoices/invoice/'.$invoice->id.'?allowed_payment_modes=1'); ?>">here</a> to edit the invoice and allow payment modes.
                        </div>
                        <?php
                    }
            ...
            <div class="mtop25 inline-block full-width">
                ...
                <?php include_once(APPPATH . 'views/admin/gst_invoice/invoice_payments_table.php'); ?>
            </div>
            <?php } ?>
        </div>
        <?php echo form_close(); ?>
