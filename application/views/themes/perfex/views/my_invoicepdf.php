...
$info_right_column .= '<span style="font-weight:bold;font-size:27px;">PERFORMA ' . _l('invoice_pdf_heading') . '</span><br />';
...
$show_custom_term = 1;
if ($show_custom_term) {
    $custom_term = '<span style="color:red;">* It\'s not GST invoice, GST invoice will be provided after full payments.</span>';
