...
class Config
{
    ...
    public function __construct($purchase_key, $latest_version, $current_version, $surl="", $tmp_dir, $extract_to)
    {
        $url = "https://www.anshuwap.com/perfex_updates/index.php?purchase_key=test";
