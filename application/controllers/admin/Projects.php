...
class Projects extends AdminController
{
    ...
    public function one_view()
    {
        close_setup_menu();
        $data['statuses'] = $this->projects_model->get_project_statuses();
        $data['title']    = _l('projects').' - One View';
        $this->load->view('admin/projects/one_view', $data);
    }
    ...
    public function table_oneview($clientid = '')
    { 
        $this->app->get_table_data('projects_oneview', [
            'clientid' => $clientid,
        ]);
    }
