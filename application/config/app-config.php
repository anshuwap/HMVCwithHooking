...
*
*/
define('APP_BASE_URL', 'https://crm.binplus.in/');
...
*/
define('APP_ENC_KEY', '12e6eb3a8854d994f2afc3ac7d1888a0');
 ...
 */
define('APP_DB_USERNAME', 'binp_crm');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'binp_crm');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'binp_crm');
