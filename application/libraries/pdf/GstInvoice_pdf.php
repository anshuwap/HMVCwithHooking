...
class GstInvoice_pdf extends App_pdf
{
    protected $invoice;
    ...
    public function __construct($invoice, $tag = '')
    {
        ...
        $this->invoice_number = format_gst_invoice_number($this->invoice->id);
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_gstinvoicepdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/gstinvoicepdf.php';
