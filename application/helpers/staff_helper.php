...
function get_available_staff_permissions($data = [])
{
    ...
    $withNotApplicableViewOwn = $allPermissionsArray;
...
function register_staff_capabilities($key, $capabilities, $name, $permissions)
{
    $permissions[$key] = [
        'name'         => $name,
 ...
 */
function get_staff_full_name($userid = '', $only_first = false)
{
    ...
    return $only_first ? $firstname : $firstname . ' ' . $lastname ;
}
